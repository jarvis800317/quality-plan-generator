...
def build_doc():
    ...
    toc_entries = [
        ...
        {'level': 1, 'title': '貳、管理權責及分工',       'page': 8},
        ...
        {'level': 1, 'title': '陸、設備功能運轉檢測程序及標準',         'page': 85},
...
# 參、工程施工要領
    ...
    work_items_methods = [
        ("整地拆除工程", [
            ("清除及掘除", "植被
廢棄物等", "推土機
怪手", "依環保規定處理廢棄物，避免二次污染"),
            ("地坪打除", "無", "怪手
破碎機", "注意地下管線位置，避免損壞既有設施"),
...
壓路機", "整修後土層應達規定壓實度"),
        ...
        ("混凝土鋪面工程", [
            ...
            ("混凝土澆置", "預拌混凝土（fc\'=210kgf/cm²以上）", "預拌車
振動棒", "坍度15±4cm，溫度13~32°C，氯離子≦0.15kg/m³"),
            ("養護", "養護膜或養護劑", "灑水設備", "養護期間不得受外力破壞，至少養護7天"),
        ]),
        ("高壓混凝土磚鋪面工程", [
            ("基底整平", "無", "整平工具", "基底壓實度≧95%"),
            ("砂漿打底", "水泥砂漿1:3", "砂漿攪拌機", "砂漿厚度均勻，鋪設後立即鋪磚"),
            ("鋪設高壓磚", "高壓混凝土磚（抗壓強度≧350kgf/cm²）", "橡皮槌
水準儀", "坡度符合圖說，縫隙均勻，垂直度確認"),
            ("填縫", "細砂或填縫劑", "掃把
振動板", "填縫完整，表面清潔"),
        ]),
        ("路緣石工程", [
...
模板", "基礎強度及尺寸符合結構計算"),
            ("鋼構安裝", "型鋼
鍍鋅螺栓", "吊車
焊接設備", "鋼構組裝精準，焊接品質符合規範"),
            ("塑木安裝", "塑木板材", "電鑽
螺絲", "塑木間距均勻，固定牢固，螺絲不外露"),
            ("防腐防蝕處理", "防蝕塗昘", "噴塗設備", "金屬件均應熱浸鍍鋅或塗防蝕漆"),
        ]),
        ("兒童遊戲場設備工程", [
            ("基礎施工", "混凝土基礎", "模板
混凝土", "基礎尺寸及強度符合設備廠商規定"),
...
工具組", "依廠商施工圖安裝，確認鎖固扭力"),
            ("地坪鋪設", "彈性地坪
橡膠地墊
人工草皮", "整平工具", "厚度及面積符合設計，落高防護符合CNS規定"),
            ("安全性確認", "無", "無", "確認無尖銳物
夾縫
吞噬點，符合CNS12642遊戲場安全規範"),
        ]),
        ("公園排水工程", [
            ("溝槽開挖", "無", "怪手", "開挖位置及深度符合圖說"),
            ("管材安裝", "HDPE透水網管
PVC管", "無", "管材坡度符合設計，接頭密合"),
            ("陰井施工", "預鑄陰井或現場灌漿", "模板
混凝土", "陰井高程符合設計，蓋板牢固"),
...
客土", "無", "土壤改良充分，排水良好"),
            ("植樹", "各類喬木
灌木", "吊車（大型喬木）", "種植深度適當，支撐架設置牢固"),
            ("植草", "假儉草", "無", "舖植密實，確認存活"),
            ("養護", "水
肥昘", "澆水設備", "養護期間至少6個月，確保存活率≧90%"),
        ]),
        ("景觀照明工程", [
            ("管線埋設", "PVC管
XLPE電纜", "無", "管線埋設深度符合電工法規，轉角處留餘裕"),
            ("燈座基礎", "混凝土基礎", "模板
混凝土", "基礎強度及尺寸符合燈具廠商規定"),
            ("燈具安裝", "各類景觀燈具", "工具組", "燈具方向
角度符合設計，鎖固確實"),
            ("電氣配線", "電纜
接線盒", "電工工具", "線徑符合設計，接頭絕緣確實"),
            ("功能測試", "無", "照度計
電錶", "照度符合設計規定，絕緣電阻≧1MΩ"),
        ]),
    ]
...
add_table_caption(doc, 3, idx + 1, f"{work_name}工程施工要領")
    ...
    # 伍、材料與設備及施工檢驗程序
    # ════════════════════════════════
    heading(doc, "伍、材料與設備及施工檢驗程序", level=1)
    ...
    make_table(doc,
               ...
               rows=[
                   ("1", "預拌混凝土（配比設計資昘）", "施工規範03050", "施工前15日", "10日", ""),
    ...
    # 陸、設備功能運轉檢測程序及標準
    # ════════════════════════════════
    heading(doc, "陸、設備功能運轉檢測程序及標準", level=1)
